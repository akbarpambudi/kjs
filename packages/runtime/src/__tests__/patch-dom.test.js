...
test('patch text', () => {
    const oldVdom = hText('foo')
    const newVdom = hText('bar')
...
describe('patch fragments', () => {
    test('nested fragments, add child', () => {
        const oldVdom = hFragment([hFragment([hText('foo')])])
        const newVdom = hFragment([
            hFragment([hText('foo'), hText('bar')]),
            h('p', {}, ['baz']),
        ])
    ...
    test('nested fragments, add child at index', () => {
        const oldVdom = hFragment([
            hText('A'),
            hFragment([hText('B'), hText('C')]),
        ])
        const newVdom = hFragment([
            hFragment([hText('X')]),
            hText('A'),
            hFragment([hText('B'), hFragment([hText('Y')]), hText('C')]),
        ])
